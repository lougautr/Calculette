...
public interface CalculetteListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#lire}.
	 * @param ctx the parse tree
	 */
	void enterLire(CalculetteParser.LireContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#lire}.
	 * @param ctx the parse tree
	 */
	void exitLire(CalculetteParser.LireContext ctx);
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#ecrire}.
	 * @param ctx the parse tree
	 */
	void enterEcrire(CalculetteParser.EcrireContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#ecrire}.
	 * @param ctx the parse tree
	 */
	void exitEcrire(CalculetteParser.EcrireContext ctx);
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#plusEgal}.
	 * @param ctx the parse tree
	 */
	void enterPlusEgal(CalculetteParser.PlusEgalContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#plusEgal}.
	 * @param ctx the parse tree
	 */
	void exitPlusEgal(CalculetteParser.PlusEgalContext ctx);
	/**
